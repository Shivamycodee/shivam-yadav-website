    ...
    <div className="article-holder text-white mt-10 mb-10">
      <>
        ...
        <p style={{ textAlign: "justify" }}>
          <span style={{ fontFamily: "verdana, geneva, sans-serif" }}>
            Before we began with our AI, let's go through some basic data. In
            India there are 3 levels of courts , the top level is Supreme Court
            ...
            jurisdiction over a district. now let's talk about there numbers and
            total pending cases they have.
          </span>
        </p>
        <p>&nbsp;</p>
        <table
        ...
        <p>&nbsp;</p>
        <p>
          Now the Cases you have seen are divided into two type of
          cases, Civil &amp; Criminal Cases. below is the data on 
          how much each type of case contriubtes to pending cases...
          <br />
          <br />
        </p>
        <table
        ...
        <p>
          ...
          even if it means letting hundred criminals go free. The dialogue
          ...
          country's. there are other reasons like:
        </p>
        <ol>
          <li>
        ...
        <>
          <p>
            ...
            only the Civil Cases not Criminal ones. From total pending cases ,
            civil cases make up for 30% 😱 ,&nbsp; around 15,491,782.&nbsp;
          </p>
          <p>&nbsp;</p>
          ...
          <>
            ...
            <p>
              ...
              who are practicing to become judges or advocates., if they deemed a 
              judgement unfair they can apply to the higher Authority to
